...
CREATE TABLE tbusuario (
    ...
    nome TEXT NOT NULL,
    email TEXT NOT NULL,
    perfil TEXT,  -- Exemplos: 'admin', 'rh', 'funcionario'
    ativo BOOLEAN DEFAULT true,
    created_at TIMESTAMPTZ DEFAULT NOW(),
    updated_at TIMESTAMPTZ,

    CONSTRAINT tbusuario_pkey PRIMARY KEY (usuario_id),
    CONSTRAINT tbusuario_email_key UNIQUE (email)
);
...
COMMENT ON COLUMN tbusuario.perfil IS 'Perfil/role do usuário (admin, rh, funcionario, etc.)';
```
